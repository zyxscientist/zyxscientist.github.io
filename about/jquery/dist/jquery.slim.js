	...
	for ( ; index < length; index++ ) {
		...
		if ( show ) {
			...
			if ( elem.style.display === "" && jQuery.css( elem, "display" ) === "none" &&
					...
					// Support: Firefox <=42 43="" -="" don't="" set="" inline="" display="" on="" disconnected="" elements="" with="" computed="" display:="" none="" jquery.contains(="" elem.ownerdocument,="" elem="" )="" {="" values[="" index="" ]="getDefaultDisplay(" );="" }="" else="" if="" (="" !="=" "none"="" ;="" remember="" what="" we're="" overwriting="" datapriv.set(="" elem,="" "display",="" the="" of="" in="" a="" second="" loop to="" avoid="" constant="" reflow="" for="" <="" length;="" index++="" elements[="" ].style.display="values[" ];="" return="" elements;="" jquery.fn.extend(="" show:="" function()="" showhide(="" this,="" true="" },="" hide:="" this="" toggle:="" function(="" state="" typeof="" "boolean"="" ?="" this.show()="" :="" this.hide();="" this.each(="" ishidden(="" jquery(="" ).show();="" ).hide();="" var="" rcheckabletype="(" ^(?:checkbox|radio)$="" i="" rtagname="(" <([a-z][^\="" \0="">\x20\t\r\n\f]+)/i );
...
jQuery.Event = function( src, props ) {
	...
	if ( src && src.type ) {
		...
		this.isDefaultPrevented = src.defaultPrevented ||
				...
				// Support: Android<4.0 1="" 7="" 2003="" src.returnvalue="==" false="" ?="" returntrue="" :="" returnfalse;="" event="" type="" }="" else="" {="" this.type="src;" put="" explicitly="" provided="" properties="" onto="" the="" object="" if="" (="" props="" )="" jquery.extend(="" this,="" );="" create="" a="" timestamp="" incoming="" doesn't="" have="" one="" this.timestamp="src" &&="" src.timestamp="" ||="" jquery.now();="" mark="" it="" as="" fixed="" this[="" jquery.expando="" ]="true;" };="" jquery.event="" is="" based="" on="" dom3="" events="" specified="" by="" ecmascript="" language="" binding="" http:="" www.w3.org="" tr="" wd-dom-level-3-events-20030331="" ecma-script-binding.html="" jquery.event.prototype="{" constructor:="" jquery.event,="" isdefaultprevented:="" returnfalse,="" ispropagationstopped:="" isimmediatepropagationstopped:="" preventdefault:="" function()="" var="" e="this.originalEvent;" this.isdefaultprevented="returnTrue;" e.preventdefault();="" },="" stoppropagation:="" this.ispropagationstopped="returnTrue;" e.stoppropagation();="" stopimmediatepropagation:="" this.isimmediatepropagationstopped="returnTrue;" e.stopimmediatepropagation();="" this.stoppropagation();="" mouseenter="" leave="" using="" mouseover="" out="" and="" event-time="" checks="" so="" that="" delegation="" works="" in="" jquery.="" do="" same="" for="" pointerenter="" pointerleave="" pointerover="" pointerout="" support:="" safari="" only="" sends="" too="" often;="" see:="" https:="" code.google.com="" p="" chromium="" issues="" detail?id="470258" description="" of="" bug="" (it="" existed="" older="" chrome="" versions="" well).="" jquery.each(="" mouseenter:="" "mouseover",="" mouseleave:="" "mouseout",="" pointerenter:="" "pointerover",="" pointerleave:="" "pointerout"="" function(="" orig,="" fix="" jquery.event.special[="" orig="" delegatetype:="" fix,="" bindtype:="" handle:="" ret,="" target="this," related="event.relatedTarget," handleobj="event.handleObj;" call="" handler="" outside="" target.="" nb:="" no="" relatedtarget="" mouse="" left="" entered="" browser="" window="" !related="" !="=" !jquery.contains(="" target,="" event.type="handleObj.origType;" ret="handleObj.handler.apply(" arguments="" return="" ret;="" jquery.fn.extend(="" on:="" types,="" selector,="" data,="" fn="" on(="" one:="" fn,="" off:="" handleobj,="" type;="" types="" types.preventdefault="" types.handleobj="" dispatched="" jquery(="" types.delegatetarget="" ).off(="" handleobj.namespace="" handleobj.origtype="" +="" "."="" handleobj.origtype,="" handleobj.selector,="" handleobj.handler="" this;="" typeof="" "object"="" types-object="" [,="" selector]="" this.off(="" type,="" types[="" selector="==" "function"="" fn]="" this.each(="" jquery.event.remove(="" rxhtmltag="/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0">\x20\t\r\n\f]*)[^>]*)\/>/gi,
		...
		for ( ; ( elem = elems[ i ] ) !== undefined; i++ ) {
			if ( acceptData( elem ) ) {
				if ( ( data = elem[ dataPriv.expando ] ) ) {
					...
					// Support: Chrome <= 0="" 1="" 2="" 3="" 4="" 8="" 9="" 11="" 37="" 35-45+="" assign="" undefined="" instead="" of="" using="" delete,="" see="" data#remove="" elem[="" datapriv.expando="" ]="undefined;" }="" if="" (="" datauser.expando="" )="" {="" support:="" chrome="" <="35-45+" );="" jquery.fn.extend(="" detach:="" function(="" selector="" return="" remove(="" this,="" selector,="" true="" },="" remove:="" text:="" value="" access(="" ?="" jquery.text(="" this="" :="" this.empty().each(="" function()="" this.nodetype="==" ||="" this.textcontent="value;" null,="" value,="" arguments.length="" append:="" dommanip(="" arguments,="" elem="" var="" target="manipulationTarget(" target.appendchild(="" prepend:="" target.insertbefore(="" elem,="" target.firstchild="" before:="" this.parentnode="" this.parentnode.insertbefore(="" after:="" this.nextsibling="" empty:="" i="0;" for="" ;="" !="null;" i++="" elem.nodetype="==" prevent="" memory="" leaks="" jquery.cleandata(="" getall(="" false="" remove="" any="" remaining="" nodes="" elem.textcontent="" this;="" clone:="" dataandevents,="" deepdataandevents="" dataandevents="dataAndEvents" =="null" dataandevents;="" deepdataandevents;="" this.map(="" jquery.clone(="" html:="" {},="" l="this.length;" &&="" elem.innerhtml;="" we="" can="" take="" a="" shortcut="" and="" just="" use="" innerhtml="" typeof="" "string"="" !rnoinnerhtml.test(="" !wrapmap[="" rtagname.exec(="" [="" "",="" ""="" )[="" ].tolowercase()="" try="" l;="" {};="" element="" elem.innerhtml="value;" throws="" an="" exception,="" the="" fallback="" method="" catch="" e="" {}="" this.empty().append(="" replacewith:="" ignored="[];" make="" changes,="" replacing="" each="" non-ignored="" context="" with="" new="" content="" parent="this.parentNode;" jquery.inarray(="" parent.replacechild(="" force="" callback="" invocation="" jquery.each(="" appendto:="" "append",="" prependto:="" "prepend",="" insertbefore:="" "before",="" insertafter:="" "after",="" replaceall:="" "replacewith"="" name,="" original="" jquery.fn[="" name="" elems,="" ret="[]," insert="jQuery(" ),="" last="insert.length" -="" 1,="" elems="i" this.clone(="" jquery(="" insert[="" ](="" android<4.1,="" phantomjs<2="" .get()="" because="" push.apply(_,="" arraylike)="" on="" ancient="" webkit="" push.apply(="" ret,="" elems.get()="" this.pushstack(="" };="" rmargin="(" ^margin="" rnumnonpx="new" regexp(="" "^("="" +="" pnum="" ")(?!px)[a-z%]+$",="" "i"="" getstyles="function(" ie<="11+," firefox<="30+" (#15098,="" #14150)="" ie="" elements="" created="" in="" popups="" ff="" meanwhile="" frame="" through="" "defaultview.getcomputedstyle"="" view="elem.ownerDocument.defaultView;" !view.opener="" view.getcomputedstyle(="" documentelement="document.documentElement;" pixelpositionval,="" boxsizingreliableval,="" pixelmarginrightval,="" reliablemarginleftval,="" container="document.createElement(" "div"="" div="document.createElement(" finish="" early="" limited="" (non-browser)="" environments="" !div.style="" return;="" ie9-11+="" style="" cloned="" affects="" source="" (#8908)="" div.style.backgroundclip="content-box" div.clonenode(="" ).style.backgroundclip="" support.clearclonestyle="div.style.backgroundClip" "content-box";="" container.style.csstext="border:0;width:8px;height:0;top:0;left:-9999px;" "padding:0;margin-top:1px;position:absolute";="" container.appendchild(="" executing="" both="" pixelposition="" &="" boxsizingreliable="" tests="" require="" only="" one="" layout="" so="" they're="" executed="" at="" same="" time="" to="" save="" second="" computation.="" function="" computestyletests()="" div.style.csstext="box-sizing:border-box;" "position:relative;display:block;"="" "margin:auto;border:1px;padding:1px;"="" "top:1%;width:50%";="" div.innerhtml="" documentelement.appendchild(="" divstyle="window.getComputedStyle(" pixelpositionval="divStyle.top" "1%";="" reliablemarginleftval="divStyle.marginLeft" "2px";="" boxsizingreliableval="divStyle.width" "4px";="" android="" 4.0="" 4.3="" some="" styles="" come="" back="" percentage="" values,="" even="" though="" they="" shouldn't="" div.style.marginright="50%" pixelmarginrightval="divStyle.marginRight" documentelement.removechild(="" jquery.extend(="" support,="" pixelposition:="" test="" is="" once="" but="" still="" do="" memoizing="" since="" pre-computing.="" no="" need="" check="" was="" already="" performed,="" though.="" computestyletests();="" pixelpositionval;="" boxsizingreliable:="" null="" boxsizingreliableval;="" pixelmarginright:="" 4.0-4.3="" we're="" checking="" here="" that="" compresses="" better="" computed="" together="" anyway.="" pixelmarginrightval;="" reliablemarginleft:="" only,="" firefox="" reliablemarginleftval;="" )();="" curcss(="" width,="" minwidth,="" maxwidth,="" getstyles(="" ie9="" getpropertyvalue="" needed="" .css('filter')="" (#12537)="" computed[="" ];="" !jquery.contains(="" elem.ownerdocument,="" tribute="" "awesome="" hack="" by="" dean="" edwards"="" browser="" returns="" width="" seems="" be="" reliably="" pixels.="" against="" cssom="" draft="" spec:="" http:="" dev.w3.org="" csswg="" #resolved-values="" !support.pixelmarginright()="" rnumnonpx.test(="" rmargin.test(="" remember="" values="" minwidth="style.minWidth;" maxwidth="style.maxWidth;" put="" get="" out="" style.minwidth="style.maxWidth" style.width="ret;" revert="" changed="" style.maxwidth="maxWidth;" zindex="" as="" integer.="" ret;="" addgethookif(="" conditionfn,="" hookfn="" define="" hook,="" we'll="" first="" run="" it's="" really="" needed.="" get:="" conditionfn()="" hook="" not="" (or="" possible="" it="" due="" missing="" dependency),="" it.="" delete="" this.get;="" needed;="" redefine="" support="" again.="" this.get="hookFn" ).apply(="" arguments="" swappable="" display="" none="" or="" starts="" table="" except="" "table",="" "table-cell",="" "table-caption"="" values:="" https:="" developer.mozilla.org="" en-us="" docs="" css="" rdisplayswap="/^(none|table(?!-c[ea]).+)/," cssshow="{" position:="" "absolute",="" visibility:="" "hidden",="" display:="" "block"="" cssnormaltransform="{" letterspacing:="" "0",="" fontweight:="" "400"="" cssprefixes="[" "webkit",="" "moz",="" "ms"="" ],="" emptystyle="document.createElement(" ).style;="" property="" mapped="" potentially="" vendor="" prefixed="" vendorpropname(="" names="" are="" name;="" capname="name[" ].touppercase()="" name.slice(="" while="" i--="" capname;="" setpositivenumber(="" subtract="" relative="" (+="" -)="" have="" been="" normalized="" point="" matches="rcssNum.exec(" guard="" "subtract",="" e.g.,="" when="" used="" csshooks="" math.max(="" 0,="" matches[="" "px"="" value;="" augmentwidthorheight(="" extra,="" isborderbox,="" isborderbox="" "border"="" "content"="" right="" measurement,="" avoid="" augmentation="" otherwise="" initialize="" horizontal="" vertical="" properties="" "width"="" val="0;" 4;="" box="" models="" exclude="" margin,="" add="" want="" extra="==" "margin"="" cssexpand[="" true,="" border-box="" includes="" padding,="" "padding"="" point,="" isn't="" border="" nor="" "width",="" else="" content,="" padding="" val;="" getwidthorheight(="" start="" offset="" property,="" which="" equivalent="" val,="" valueisborderbox="true," "boxsizing",="" false,="" "border-box";="" running="" getboundingclientrect="" disconnected="" node="" error.="" elem.getclientrects().length="" ie11="" fullscreen="" inside="" iframe="" 100x="" too="" small="" dimensions="" (gh-1764).="" document.msfullscreenelement="" window.top="" window="" *="100;" non-html="" offsetwidth,="" svg="" bugzilla.mozilla.org="" show_bug.cgi?id="649285" mathml="" fall="" then="" uncomputed="" necessary="" unit="" stop="" return.="" case="" unreliable="" getcomputedstyle="" silently="" falls="" reliable="" elem.style="" support.boxsizingreliable()="" elem.style[="" normalize="" auto,="" prepare="" 0;="" active="" box-sizing="" model="" irrelevant="" valueisborderbox,="" "px";="" hooks="" overriding="" default behavior="" getting="" setting="" csshooks:="" opacity:="" should="" always="" number="" from="" opacity="" "opacity"="" "1"="" don't="" automatically="" these="" possibly-unitless="" cssnumber:="" "animationiterationcount":="" "columncount":="" "fillopacity":="" "flexgrow":="" "flexshrink":="" "fontweight":="" "lineheight":="" "opacity":="" "order":="" "orphans":="" "widows":="" "zindex":="" "zoom":="" whose="" you="" wish="" fix="" before="" cssprops:="" "float":="" "cssfloat"="" set="" dom="" style:="" text="" comment="" !elem="" !elem.style="" sure="" working="" type,="" hooks,="" origname="jQuery.camelCase(" jquery.cssprops[="" gets="" version,="" unprefixed="" version="" jquery.csshooks[="" type="typeof" convert="" "+=" or " string"="" ret[="" fixes="" bug="" #9237="" nan="" aren't="" (#7116)="" passed="" in,="" (except="" certain="" properties)="" "number"="" jquery.cssnumber[="" background-*="" props="" affect="" clone's="" !support.clearclonestyle="" name.indexof(="" "background"="" style[="" provided,="" specified="" !hooks="" !(="" "set"="" provided="" non-computed="" there="" "get"="" object="" css:="" num,="" followed="" otherwise,="" way="" exists,="" "normal"="" numeric="" forced="" qualifier="" looks="" num="parseFloat(" isfinite(="" "height",="" i,="" computed,="" dimension="" info="" invisibly="" show="" them="" must="" current="" would="" benefit="" rdisplayswap.test(="" jquery.css(="" "display"="" safari="" 8+="" columns="" non-zero="" offsetwidth="" zero="" getboundingclientrect().width="" unless="" changed.="" !elem.getclientrects().length="" !elem.getboundingclientrect().width="" swap(="" cssshow,="" set:="" matches,="" "border-box",="" pixels="" adjustment="" jquery.csshooks.marginleft="addGetHookIf(" support.reliablemarginleft,="" parsefloat(="" "marginleft"="" elem.getboundingclientrect().left="" marginleft:="" elem.getboundingclientrect().left;="" animate="" expand="" margin:="" padding:="" border:="" prefix,="" suffix="" prefix="" expand:="" expanded="{}," assumes="" single="" string="" parts="typeof" value.split(="" "="" expanded[="" parts[="" expanded;="" !rmargin.test(="" ].set="setPositiveNumber;" styles,="" len,="" map="{}," jquery.isarray(="" len="name.length;" len;="" map[="" name[="" map;="" jquery.style(=""> 1 );
	}
} );
...
( function() {
	...
	// Support: Android<4.4 default value="" for="" a="" checkbox="" should="" be="" "on"="" support.checkon="input.value" !="=" "";="" support:="" ie<="11+" must="" access="" selectedindex="" to="" make="" options="" select="" support.optselected="opt.selected;" an="" input="" loses="" its="" after="" becoming="" radio="" "input"="" );="" input.value="t" ;="" input.type="radio" support.radiovalue="input.value" =="=" "t";="" }="" )();="" var="" boolhook,="" attrhandle="jQuery.expr.attrHandle," exclusively="" lowercase="" a-z="" in="" attribute="" names="" (gh-2730)="" https:="" dom.spec.whatwg.org="" #converted-to-ascii-lowercase="" raz="/[A-Z]+/g," ch="" )="" {="" return="" ch.tolowercase();="" };="" jquery.fn.extend(="" attr:="" function(="" name,="" access(="" this,="" jquery.attr,="" value,="" arguments.length=""> 1 );
	},
	...
	valHooks: {
		option: {
			get: function( elem ) {
				...
				// Support: IE<11 0="" 1="" option.value="" not="" trimmed="" (#14858)="" return="" jquery.trim(="" elem.value="" );="" }="" },="" select:="" {="" get:="" function(="" elem="" )="" var="" value,="" option,="" options="elem.options," index="elem.selectedIndex," one="elem.type" =="=" "select-one",="" values="one" ?="" null="" :="" [],="" max="one" +="" options.length,="" i="index" <="" 0;="" loop through="" all="" the="" selected for="" (="" ;="" max;="" i++="" option="options[" ];="" ie8-9="" doesn't="" update="" after="" form="" reset="" (#2551)="" if="" option.selected="" ||="" &&="" don't="" that="" are="" disabled or="" in="" a="" optgroup="" !option.disabled="" !option.parentnode.disabled="" !jquery.nodename(="" option.parentnode,="" "optgroup"="" get="" specific="" value="" ).val();="" we="" need="" an="" array="" selects="" value;="" multi-selects="" values.push(="" values;="" set:="" elem,="" optionset,="" ),="" while="" i--="" jquery.valhooks.option.get(=""> -1
					) {
						optionSet = true;
					}
				}
...
jQuery.param = function( a, traditional ) {
	...
	// Set traditional to true for jQuery <= 1="" 8="" 9="" 1.3.2="" behavior.="" if="" (="" traditional="==" undefined="" )="" {="" &&="" jquery.ajaxsettings.traditional;="" }="" an="" array="" was="" passed="" in,="" assume="" that="" it="" is="" of="" form="" elements.="" jquery.isarray(="" a="" ||="" a.jquery="" !jquery.isplainobject(="" serialize="" the="" elements="" jquery.each(="" a,="" function()="" add(="" this.name,="" this.value="" );="" else="" traditional,="" encode="" "old"="" way="" (the="" or="" older="" did="" it),="" otherwise="" params="" recursively.="" for="" prefix="" in="" buildparams(="" prefix,="" a[="" ],="" add="" return="" resulting="" serialization="" s.join(="" "&"="" };="" jquery.fn.extend(="" serialize:="" jquery.param(="" this.serializearray()="" },="" serializearray:="" this.map(="" can="" prophook="" "elements"="" to="" filter="" var="" this,="" ?="" jquery.makearray(="" :="" this;="" .filter(="" type="this.type;" use="" .is(="" ":disabled"="" so="" fieldset[disabled]="" works="" this.name="" !jquery(="" this="" ).is(="" rsubmittable.test(="" this.nodename="" !rsubmittertypes.test(="" this.checked="" !rcheckabletype.test(="" .map(="" function(="" i,="" elem="" val="jQuery(" ).val();="" null="" jquery.map(="" val,="" name:="" elem.name,="" value:="" val.replace(="" rcrlf,="" "\r\n"="" ).get();="" support:="" safari="" 8+="" documents="" created="" via="" document.implementation.createhtmldocument="" collapse="" sibling="" forms:="" second="" one="" becomes="" child="" first="" one.="" because="" that,="" security="" measure="" has="" be="" disabled 8.="" https:="" bugs.webkit.org="" show_bug.cgi?id="137337" support.createhtmldocument="(" body="document.implementation.createHTMLDocument(" ""="" ).body;="" body.innerhtml="<form></form><form></form>" ;="" body.childnodes.length="==" 2;="" )();="" argument="" "data"="" should="" string="" html="" context="" (optional):="" specified,="" fragment="" will="" context,="" defaults="" document="" keepscripts="" true,="" include="" scripts="" jquery.parsehtml="function(" data,="" typeof="" data="" !="=" "string"="" [];="" "boolean"="" stop="" inline="" event="" handlers="" from="" being="" executed="" immediately="" by="" using="" document.implementation="" document.implementation.createhtmldocument(="" parsed="rsingleTag.exec(" ),="" single="" tag="" [="" context.createelement(="" parsed[="" ]="" ];="" scripts.length="" jquery(="" ).remove();="" jquery.merge(="" [],="" parsed.childnodes="" **="" *="" gets="" window="" element="" function="" getwindow(="" jquery.iswindow(="" elem.nodetype="==" elem.defaultview;="" jquery.offset="{" setoffset:="" elem,="" options,="" i="" curposition,="" curleft,="" curcsstop,="" curtop,="" curoffset,="" curcssleft,="" calculateposition,="" position="jQuery.css(" "position"="" curelem="jQuery(" props="{};" set="" first,="" in-case="" top="" left="" are="" even="" on="" static="" "static"="" elem.style.position="relative" curoffset="curElem.offset();" curcsstop="jQuery.css(" "top"="" curcssleft="jQuery.css(" "left"="" calculateposition="(" "absolute"="" "fixed"="" +="" ).indexof(="" "auto"=""> -1;
...
jQuery.fn.extend( {
	offset: function( options ) {
		...
		// Support: IE</=></11></4.4></=></4.1,></script|<style|<link></4.0></=42+></4.2></|&#?\w+;></tbody></=42></=></=></"></)></tag></\></537.32></9,></9></8></9></option></29,></8></option></4.0></24></4.0></4.1>